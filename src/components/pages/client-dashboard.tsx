          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-primary-100 p-8 text-center">
            ...
            <div className="bg-gradient-to-r from-primary-50 to-primary-100 rounded-2xl p-4 mb-8 border border-primary-200">
              <div className="flex items-center justify-center space-x-3">
                ...
                <div className="text-left">
                  <p className="font-medium text-charcoal-900">{supabaseUser.email}</p>
                  <p className="text-sm text-charcoal-600">Ready to get started</p>
                </div>
              </div>
            </div>
              ...
              onClick={async () => {
                try {
                  ...
                  const { data, error } = await supabase.from('users').insert({
                    ...
                    first_name: supabaseUser.user_metadata?.first_name || 'Michael',
                    last_name: supabaseUser.user_metadata?.last_name || 'Guirguis',
            ...
            <div className="mt-8 grid grid-cols-3 gap-4 text-center">
              <div className="p-3">
                ...
                <p className="text-xs text-charcoal-600 font-medium">Analytics</p>
              </div>
              <div className="p-3">
              ...
              <div className="p-3">
                ...
                <p className="text-xs text-charcoal-600 font-medium">Projects</p>
              </div>
            </div>
          </div>
        </div>
