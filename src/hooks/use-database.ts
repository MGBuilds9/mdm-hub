...
export const queryKeys = {
  ...
  usersByDivision: (divisionId: string) => ['users', 'division', divisionId] as const,
  ...
  projectsByDivision: (divisionId: string) => ['projects', 'division', divisionId] as const,
  
  photos: ['photos'] as const,
  photosByProject: (projectId: string) => ['photos', 'project', projectId] as const,
  photoWithDetails: (id: string) => ['photos', id, 'details'] as const,
  
  changeOrders: ['change-orders'] as const,
  changeOrdersByProject: (projectId: string) => ['change-orders', 'project', projectId] as const,
  changeOrderWithDetails: (id: string) => ['change-orders', id, 'details'] as const,
  
  notifications: ['notifications'] as const,
  notificationsByUser: (userId: string) => ['notifications', 'user', userId] as const,
  unreadNotifications: (userId: string) => ['notifications', 'user', userId, 'unread'] as const,
}
...
export const useUpdateUser = () => {
  ...
  return useMutation({
    ...
    onSuccess: (data, variables) => {
      ...
      queryClient.invalidateQueries({ queryKey: queryKeys.userWithDivisions(variables.id) })
      toast({
        title: 'Success',
...
export const useCreateDivision = () => {
  ...
  return useMutation({
    mutationFn: (division: Omit<Division, 'id' | 'created_at' | 'updated_at'>) =>
...
export const useUpdateDivision = () => {
  ...
  return useMutation({
    ...
    onSuccess: (data, variables) => {
      queryClient.invalidateQueries({ queryKey: queryKeys.division(variables.id) })
      queryClient.invalidateQueries({ queryKey: queryKeys.divisions })
      toast({
        title: 'Success',
...
export const useCreateProject = () => {
  ...
  return useMutation({
    ...
    onSuccess: (data) => {
      ...
      queryClient.invalidateQueries({ queryKey: queryKeys.projectsByDivision(data.division_id) })
      toast({
        title: 'Success',
...
export const useUpdateProject = () => {
  ...
  return useMutation({
    ...
    onSuccess: (data, variables) => {
      ...
      queryClient.invalidateQueries({ queryKey: queryKeys.projectWithDetails(variables.id) })
      queryClient.invalidateQueries({ queryKey: queryKeys.projects })
      queryClient.invalidateQueries({ queryKey: queryKeys.projectsByDivision(data.division_id) })
      toast({
        title: 'Success',
...
export const useDeleteProject = () => {
  ...
  return useMutation({
    ...
    onSuccess: (_, id) => {
      ...
      queryClient.invalidateQueries({ queryKey: queryKeys.projectWithDetails(id) })
      toast({
        title: 'Success',
...
export const useCreatePhoto = () => {
  ...
  return useMutation({
    ...
    onSuccess: (data) => {
      queryClient.invalidateQueries({ queryKey: queryKeys.photosByProject(data.project_id) })
...
export const useUpdatePhoto = () => {
  ...
  return useMutation({
    ...
    onSuccess: (data, variables) => {
      queryClient.invalidateQueries({ queryKey: queryKeys.photoWithDetails(variables.id) })
      queryClient.invalidateQueries({ queryKey: queryKeys.photosByProject(data.project_id) })
      toast({
        title: 'Success',
...
export const useDeletePhoto = () => {
  ...
  return useMutation({
    ...
    onSuccess: (_, id) => {
      queryClient.invalidateQueries({ queryKey: queryKeys.photos })
      queryClient.invalidateQueries({ queryKey: queryKeys.photoWithDetails(id) })
      toast({
        title: 'Success',
...
export const useCreateChangeOrder = () => {
  ...
  return useMutation({
    mutationFn: (changeOrder: Omit<ChangeOrder, 'id' | 'created_at' | 'updated_at'>) =>
      changeOrderService.create(changeOrder),
    onSuccess: (data) => {
      queryClient.invalidateQueries({ queryKey: queryKeys.changeOrdersByProject(data.project_id) })
...
export const useUpdateChangeOrder = () => {
  ...
  return useMutation({
    ...
    onSuccess: (data, variables) => {
      queryClient.invalidateQueries({ queryKey: queryKeys.changeOrderWithDetails(variables.id) })
      queryClient.invalidateQueries({ queryKey: queryKeys.changeOrdersByProject(data.project_id) })
      toast({
        title: 'Success',
...
export const useCreateNotification = () => {
  ...
  return useMutation({
    mutationFn: (notification: Omit<Notification, 'id' | 'sent_at' | 'read_at'>) =>
      notificationService.create(notification),
    onSuccess: (data) => {
      queryClient.invalidateQueries({ queryKey: queryKeys.notificationsByUser(data.user_id) })
      queryClient.invalidateQueries({ queryKey: queryKeys.unreadNotifications(data.user_id) })
      toast({
        title: 'Success',
